...
\begin{figure}[h]
    \centering
    \subfigure[Evolution of Gamma with stock price]{\includegraphics[width=0.45\textwidth]{images/stock_vs_gamma.png}}
    \hfill
    \subfigure[Daily profit and loss compared to Gamma]{\includegraphics[width=0.45\textwidth]{images/gamma_pnl.png}}
    \label{fig:gamma}
\end{figure}
